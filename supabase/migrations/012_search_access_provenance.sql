-- 012_search_access_provenance.sql
-- Return why a canonical video is visible to the current user alongside each
-- semantic search hit. Access remains gated by user_channels or user_videos.
